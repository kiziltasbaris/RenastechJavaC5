...
public class MultipleDimension {
    ...
    public static void main(String[] args) {
        ...
        //container indexes             0            1          2
        //index for each number      0  1  2         0 1  2  ,   0  1

        System.out.println("arr 2d : " + arr2.length);  //4

        System.out.println("Length is : " + arr2[2].length); //2

        //arr [][]
        //first bracket is always container number
        //second one is index of variable

        System.out.println(  arr2[1][2] );  //40
        //arr2[1][2]  : get index1 container and get index2 from index1 container
